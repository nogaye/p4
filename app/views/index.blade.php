...
<i style="color: #5cb85c" class="btn fa fa-smile-o fa-5x" onclick="moodSelected('happy')"></i>
<i style="color: #ec971f" class="btn fa fa-meh-o fa-5x" onclick="moodSelected('meh')"></i>
<i style="color: #d9534f" class="btn fa fa-frown-o fa-5x" onclick="moodSelected('sad')"></i>
    </div>
